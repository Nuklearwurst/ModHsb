...
public class ContainerTerminalIC2 extends Container {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int id)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            //from player:
           //Ic2 Upgrades
            else if(Settings.ic2Available && (stack.isItemEqual(PluginIC2.getIC2Item("transformerUpgrade")) || stack.isItemEqual(PluginIC2.getIC2Item("energyStorageUpgrade")) || stack.isItemEqual(PluginIC2.getIC2Item("overclockerUpgrade"))))
            {
